...
cd ..; CC=arm-linux-gnueabihf-gcc-4.8 CXX=arm-linux-gnueabihf-g++-4.8 node-gyp rebuild --arch=armv7; cd tools; cp ../build/Release/MistApi.node ../bin/MistApi-${ARCH}.node; arm-linux-gnueabihf-strip ../bin/MistApi-${ARCH}.node; 
