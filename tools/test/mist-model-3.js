...
describe('Mist Model special test 3', function () {
    ...
    before('should start a mist node, last added endpoint is a "child node" (tree.leaf)', function(done) {
        ...
        addEp(node, "item1");
        addEp(node, "item1.item2");
        addEp(node, "item1.item2.item3");
        addEp(node, "item1.item2.item3.item4");
        addEp(node, "item1.item2.subitem");
        addEp(node, "item1.item7");
        addEp(node, "item1.item7.item8");
        setTimeout(done, 200);
    });  
